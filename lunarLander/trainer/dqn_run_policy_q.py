...
def evaluate_policy_worker(policy_filename, episodes, render, goal_state, goal_reward, grid_w, grid_h, extra_dims):
    ...
    This version handles the sequential state 'q'.
    """
    ...
    for ep in range(episodes):
        ...
        while not (terminated or truncated):
            # Augment state with 'q'
            state_aug = np.append(obs, q)
...
# =====================================================================
# PLOTTING FUNCTIONS (Identical to the other script)
# =====================================================================
...
def main():
    ...
    parser.add_argument("--extra-dims", type=int, default=1, help="Number of extra dimensions for the state space (must be 1 for 'q')")
